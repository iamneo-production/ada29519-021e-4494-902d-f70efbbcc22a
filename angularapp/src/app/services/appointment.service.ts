...
export class AppointmentService {
  getappointmentURL ="https://8080-cedfeaebafbbabccfffbabacbdeefceabbedabdfbab.project.examly.io/user/appointments"
  bookappointmentURL="https://8080-cedfeaebafbbabccfffbabacbdeefceabbedabdfbab.project.examly.io/user/appointment"
  editappointmentURL="https://8080-cedfeaebafbbabccfffbabacbdeefceabbedabdfbab.project.examly.io/user/editappointment"
  deleteappointmentURL="https://8080-cedfeaebafbbabccfffbabacbdeefceabbedabdfbab.project.examly.io/user/cancelappointment"
