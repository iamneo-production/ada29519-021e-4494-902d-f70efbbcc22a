    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           // services.AddScoped<IProductService, ProductService>();
            ...
            var connectionString = "User ID=sa;password=examlyMssql@123;server=localhost;Database=myacservice;trusted_connection=false; Persist Security Info=False;Encrypt=False";
            services.AddDbContext<AcServiceDbContext>(options => options.UseSqlServer(connectionString));
