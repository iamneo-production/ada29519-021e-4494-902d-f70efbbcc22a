...
import { Reviewresponse, Reviews } from '../helpers/reviews';

@Injectable({
  providedIn: 'root'
})
export class AppointmentService {
  getappointmentURL ="https://8080-bfdadcacfdfbdefffbabacbdeedecebedadbdbbef.project.examly.io/user/appointments"
  bookappointmentURL="https://8080-bfdadcacfdfbdefffbabacbdeedecebedadbdbbef.project.examly.io/user/appointment"
  editappointmentURL="https://8080-bfdadcacfdfbdefffbabacbdeedecebedadbdbbef.project.examly.io/user/editappointment"
  deleteappointmentURL="https://8080-bfdadcacfdfbdefffbabacbdeedecebedadbdbbef.project.examly.io/user/cancelappointment"
  feedbackURl="https://8080-bfdadcacfdfbdefffbabacbdeedecebedadbdbbef.project.examly.io/user/review"
  getfeedbackURL="https://8080-bfdadcacfdfbdefffbabacbdeedecebedadbdbbef.project.examly.io/user/getreview"
  billURL="https://8080-bfdadcacfdfbdefffbabacbdeedecebedadbdbbef.project.examly.io/user/generatebill"
